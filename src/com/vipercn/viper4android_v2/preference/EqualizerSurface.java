...
//?´?„ë¼?´?? ê¸??”¨
        mWhite = new Paint();
        mWhite.setColor(getResources().getColor(R.color.mwhite));
...
mControlBar.setColor(getResources().getColor(R.color.white));

        mControlBarKnob = new Paint();
        mControlBarKnob.setStyle(Style.FILL);
//r.color.white
        mControlBarKnob.setColor(getResources().getColor(R.color.name));
...
//ì¡°ì ˆë°?
        ...
        mFrequencyResponseBg.setColor(getResources().getColor(R.color.bar));
//?›?ž˜ ê·¸ë¼?°?´?…˜ ?ƒ‰ê¹?
...
//              res.getColor(R.color.eq_white),
//            res.getColor(R.color.eq_grey),
//            res.getColor(R.color.eq_middle),
//            res.getColor(R.color.eq_darkgrey),
//            res.getColor(R.color.eq_dark)

res.getColor(R.color.eq_bg),
           res.getColor(R.color.eq_bg),
           res.getColor(R.color.eq_bg),
            res.getColor(R.color.eq_bg),
            res.getColor(R.color.eq_bg)
...
//mFrequencyResponseBg.setColor(getResources().getColor(R.color.freq_hl2));
...
mControlBar.setColor(getResources().getColor(R.color.bar));
    }
